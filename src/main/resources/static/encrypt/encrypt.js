document.write('<script src="../encrypt/jsencrypt.min.js" type="text/javascript" charset="utf-8"></script>');
document.write('<script src="../jquery/jquery.min.js" type="text/javascript" charset="utf-8"></script>');
